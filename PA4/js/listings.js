...
async function displayListings(listings) {
    ...
    //         addFavourite(listing.id); // Call addFavourite function with listing ID
    //     });
    var linkElement = document.createElement("a");
    linkElement.href = "favourites.php";
    linkElement.target = '_blank';
        const moreinfo = document.createElement("button");
        moreinfo.textContent = "Add To Favourites";
...
function addFavourite(listingId) {
    var apiKey = localStorage.getItem('apikey'); // Assuming API key is stored in localStorage
    var data = {
        type: 'add_favourite',
        apikey: apiKey,
    ...
    fetch('https://your-api-endpoint.com/favourite.php', {
        method: 'POST',
        headers: {
