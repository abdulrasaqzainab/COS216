...
class CreateAuctionAPI {
    ...
    public function createAuction($data) {
        ...
        $sql = "INSERT INTO auctions (auction_name, start_date, end_date, listing_details, highest_bid, state, buyer_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt = $this->mysqli->prepare($sql);
        ...
        if ($highest_bid === null && $buyer_id === null) {
            $stmt->bind_param("sssssss", $auction_name, $start_date, $end_date, $listing_details, $highest_bid, $state, $buyer_id);
        } elseif ($highest_bid === null) {
            $stmt->bind_param("ssssssi", $auction_name, $start_date, $end_date, $listing_details, $highest_bid, $state, $buyer_id);
        } else {
            $stmt->bind_param("ssssdsd", $auction_name, $start_date, $end_date, $listing_details, $highest_bid, $state, $buyer_id);
        }
